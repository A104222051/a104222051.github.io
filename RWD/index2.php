...
<html>
	...
	<div class="id_wrapper">
		<header class="header">
            <a href="index2.html" class="logo" style="text-decoration:none;color:#fff;">來吃飯</a>
            <input class="menu-btn" type="checkbox" id="menu-btn" />
            <label class="menu-icon" for="menu-btn"><span class="nav-icon"></span></label>
            <ul class="menu">
                <li><a href="about.html">品牌起源</a></li>
                <li><a href="#forget">看看環境</a></li>
				<li><a href="#subscribe">?????</a></li>
                <li><a href="member_index.php">Sign in</a></li>
            </ul>
        </header>
		<div class="id_content">
			...
			<div class="DIV1" data-aos="fade-right"><img src="photos/<?php echo $row_RecBoard["news_picurl"]?>" width="30%"></div>
		  ...
		  <!-- <div class="frame">
				<div class="box">
					<img class="picture" src="https://1.bp.blogspot.com/-RQznwdreaqo/XWS5caChTnI/AAAAAAABUSY/eGJnuLSqmM8yyBuQIEQkY9OhesWtjAVBQCLcBGAs/s550/ensoku_picnic_people.png">	
					<div class="description">Hello 1</div>
				</div>
				
				<div class="box">
					<img class="picture" src="https://3.bp.blogspot.com/-1VPUxWB1TSA/WqiheF_xkMI/AAAAAAABKz0/CZI-Ro2gvR8LQqZf7BH7mMnW35HqnlhNACLcBGAs/s800/cooking_chef_woman_asia.png">
					<div class="description">Hello 2</div>
				</div>
				<div class="box">
					<img class="picture" src="food_moritsuke_good.png">
					<div class="description">Hello 3</div>
				</div>
				<div class="box">
					<img class="picture" src="https://3.bp.blogspot.com/-mP6jXPsU24A/XFfWoWIp-8I/AAAAAAABRXc/XyBJ6pi1ybkB16BsFYje6atx-31-NleDQCLcBGAs/s550/kodomosyokudou_syokuji_kids.png">
					<div class="description">Hello 4</div>
				</div>	
			</div> -->
